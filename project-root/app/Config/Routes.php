...
// ROUTES ADMIN
// ===============================
$routes->post('admin/ajouter_livre', 'Admin::ajouterLivre', ['filter' => 'isLoggedIn']);
...
$routes->get('admin/creer', 'Admin::creer_admin', ['filter' => 'isLoggedIn']);
$routes->post('admin/creer', 'Admin::creer_admin', ['filter' => 'isLoggedIn']);
...
$routes->get('livres', 'LivreController::listeLivres');
$routes->get('admin/ajouter_livre', 'LivreController::afficherFormulaireAjout');
$routes->post('admin/livres/creer', 'LivreController::creerLivreAvecAuteur');
